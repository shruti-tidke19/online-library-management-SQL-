...
-- FROM '‪C:\Users\shrut\Downloads' 
-- CSV HEADER;

-- -- -- Import Data into Customers Table
-- \COPY Customers(Customer_ID, Name, Email, Phone, City, Country) 
-- FROM 'C:\Users\shrut\Downloads\Customers.csv' 
-- CSV HEADER;

-- -- -- Import Data into Orders Table
-- \COPY Orders(Order_ID, Customer_ID, Book_ID, Order_Date, Quantity, Total_Amount) 
-- FROM 'C:\Users\shrut\Downloads\Orders.csv' 
-- CSV HEADER;
...
SELECT AVG(price) AS avg_of_fantasy FROM Books
WHERE genre ='Fantasy';
